...
},{"xhr2":1}],170:[function(require,module,exports){
'use strict';
...
},{"./hello":171,"react":168,"react-dom":3}],171:[function(require,module,exports){
'use strict';
...
var HelloWorld = function (_React$Component) {
  ...
  _createClass(HelloWorld, [{
    ...
    value: function search(e) {
      ...
      (0, _reqwest2.default)('http://localhost:8053/moves?pokemon=' + e.target.value).then(function (resp) {
        var pokemon = JSON.parse(resp.response);
        if (pokemon.moves.list.length > 0) {
          _this2.setState({ image: pokemon.image });
        } else {
          _this2.setState({ image: 'http://vignette3.wikia.nocookie.net/pokemon/images/6/66/Pok%C3%A9bola.png/revision/latest?cb=20160110191524&path-prefix=pt' });
        }
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'h1',
          null,
          'Pokemon 1st Generation Moves'
        ),
        'Pokemon Name: ',
        _react2.default.createElement('input', { type: 'text', onChange: this.search }),
